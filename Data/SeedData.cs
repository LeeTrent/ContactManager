...
namespace ContactManager.Data
{
    public static class SeedData
    {
        ...
        {
            Console.WriteLine("--------------------------------------------------------------------------------");
            Console.WriteLine("[SeedData][Initialize] : BEGIN");
        ...
        {
            Console.WriteLine("--------------------------------------------------------------------------------");
            Console.WriteLine("[SeedData][EnsureRole] : BEGIN");
            ...
            Console.WriteLine("[SeedData][EnsureRole] IR: "  + IR);
            Console.WriteLine("[SeedData][EnsureRole] : END");
            Console.WriteLine("--------------------------------------------------------------------------------");            
